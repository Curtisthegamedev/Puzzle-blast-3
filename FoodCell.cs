...
public class FoodCell : MonoBehaviour
{
    ...
    public Transform spriteObjectChildStartPos;
    public GameObject spriteObjectChild; 
    ...
    private void Start()
    {
        spriteObjectChildStartPos = this.gameObject.GetComponentInChildren<Transform>(); 
    }
